{ns hl7-fhir-r4-core.CodeSystem,
 import
 #{hl7-fhir-r4-core.value-set.concept-property-type
   ...
   zen.fhir
   hl7-fhir-r4-core.value-set.codesystem-content-mode
   ...
   hl7-fhir-r4-core.value-set.codesystem-hierarchy-meaning
 ...
 {:zen.fhir/version "0.5.18",
  ...
  {:_supplements {:confirms #{hl7-fhir-r4-core.Element/schema}},
   ...
   :_hierarchyMeaning {:confirms #{hl7-fhir-r4-core.Element/schema}},
   :jurisdiction
   {:type zen/vector,
    :every
   ...
   {:confirms #{hl7-fhir-r4-core.code/schema},
    ...
    :zen.fhir/value-set
    {:symbol
     hl7-fhir-r4-core.value-set.codesystem-content-mode/value-set,
     :strength :required},
    :zen/desc
    ...
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:code
      ...
      {:confirms #{hl7-fhir-r4-core.code/schema},
       ...
       :zen.fhir/value-set
       {:symbol
        hl7-fhir-r4-core.value-set.concept-property-type/value-set,
        :strength :required},
       :zen/desc
   ...
   :_caseSensitive {:confirms #{hl7-fhir-r4-core.Element/schema}},
   :experimental
   {:confirms #{hl7-fhir-r4-core.boolean/schema},
    :fhir/flags #{:SU},
     ...
     {:code
      ...
      {:type zen/vector,
       ...
       {:confirms #{hl7-fhir-r4-core.code/schema},
        :fhir/flags #{:SU},
        :zen.fhir/value-set
        {:symbol hl7-fhir-r4-core.value-set.filter-operator/value-set,
         :strength :required},
        :zen/desc
   ...
   {:confirms #{hl7-fhir-r4-core.code/schema},
    ...
    :zen.fhir/value-set
    {:symbol
     hl7-fhir-r4-core.value-set.codesystem-hierarchy-meaning/value-set,
     :strength :required},
   ...
   :_compositional {:confirms #{hl7-fhir-r4-core.Element/schema}},
   :contact
   {:type zen/vector,
    :every
