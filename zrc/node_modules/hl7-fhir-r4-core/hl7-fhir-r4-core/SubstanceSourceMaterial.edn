{ns hl7-fhir-r4-core.SubstanceSourceMaterial,
 import
 ...
 {:zen/tags #{zen/schema zen.fhir/base-schema},
  ...
  :zen.fhir/type "SubstanceSourceMaterial",
  :zen.fhir/profileUri
  ...
  {:parentSubstanceName
   ...
   {:type zen/vector,
    ...
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:fraction
      ...
      :_fraction {:confirms #{hl7-fhir-r4-core.Element/schema}},
      :materialType
      {:confirms #{hl7-fhir-r4-core.CodeableConcept/schema},
       :fhir/flags #{:SU},
       :zen/desc
   ...
   :_organismName {:confirms #{hl7-fhir-r4-core.Element/schema}},
   :sourceMaterialState
   {:confirms #{hl7-fhir-r4-core.CodeableConcept/schema},
    :fhir/flags #{:SU},
