{ns hl7-fhir-r4-core.GraphDefinition,
 import
 #{hl7-fhir-r4-core.integer
   hl7-fhir-r4-core.value-set.graph-compartment-rule
   hl7-fhir-r4-core.BackboneElement
   hl7-fhir-r4-core.canonical
   hl7-fhir-r4-core.value-set.resource-types
   hl7-fhir-r4-core.value-set.graph-compartment-use
   hl7-fhir-r4-core.markdown
   hl7-fhir-r4-core.code
   hl7-fhir-r4-core.value-set.compartment-type
   zen.fhir
   ...
   {:type zen/vector,
    ...
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:description
      ...
      :_sliceName {:confirms #{hl7-fhir-r4-core.Element/schema}},
      :sliceName
      {:confirms #{hl7-fhir-r4-core.string/schema},
          ...
          {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
           ...
           {:description
            ...
            {:confirms #{hl7-fhir-r4-core.code/schema},
             :zen.fhir/value-set
             {:symbol
              hl7-fhir-r4-core.value-set.graph-compartment-use/value-set,
              :strength :required},
            ...
            {:confirms #{hl7-fhir-r4-core.code/schema},
             :zen.fhir/value-set
             {:symbol
              hl7-fhir-r4-core.value-set.graph-compartment-rule/value-set,
              :strength :required},
            ...
            {:confirms #{hl7-fhir-r4-core.code/schema},
             :zen.fhir/value-set
             {:symbol
              hl7-fhir-r4-core.value-set.compartment-type/value-set,
              :strength :required},
             :zen/desc
             "Patient | Encounter | RelatedPerson | Practitioner | Device"},
            :_rule {:confirms #{hl7-fhir-r4-core.Element/schema}},
            :_use {:confirms #{hl7-fhir-r4-core.Element/schema}}},
           :require #{:use :rule :code},
           :zen/desc "Compartment Consistency Rules"}},
         :link
         {:type zen/vector,
          :every {:zen/desc "Additional links from target resource"}}},
        :require #{:type},
