  ...
  {:category
   {:type zen/vector,
    ...
    {:confirms #{hl7-fhir-r4-core.CodeableConcept/schema},
     :zen.fhir/value-set
     {:symbol
      hl7-fhir-r4-core.value-set.observation-category/value-set,
      :strength :preferred},
    ...
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:low
      ...
      {:confirms #{hl7-fhir-r4-core.CodeableConcept/schema},
       :zen.fhir/value-set
       {:symbol
        hl7-fhir-r4-core.value-set.referencerange-meaning/value-set,
        :strength :preferred},
   ...
   {:confirms #{hl7-fhir-r4-core.code/schema},
    :fhir/flags #{:SU :?!},
    :zen.fhir/value-set
    {:symbol hl7-fhir-r4-core.value-set.observation-status/value-set,
     :strength :required},
   ...
   {:type zen/vector,
    ...
    {:confirms #{hl7-fhir-r4-core.Reference/schema zen.fhir/Reference},
     ...
     :zen.fhir/reference
     {:refers
      #{hl7-fhir-r4-core.MedicationDispense/schema
