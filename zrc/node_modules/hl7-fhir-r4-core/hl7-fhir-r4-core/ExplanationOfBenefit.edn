{ns hl7-fhir-r4-core.ExplanationOfBenefit,
 import
 #{hl7-fhir-r4-core.Period
   ...
   hl7-fhir-r4-core.value-set.explanationofbenefit-status
   ...
   hl7-fhir-r4-core.value-set.claim-use
 ...
 {:zen.fhir/version "0.5.18",
  ...
  {:_created {:confirms #{hl7-fhir-r4-core.Element/schema}},
   ...
   {:confirms #{hl7-fhir-r4-core.Reference/schema zen.fhir/Reference},
    :zen.fhir/reference
    {:refers #{hl7-fhir-r4-core.ClaimResponse/schema}},
    :zen/desc "Claim response reference"},
   :insurance
   {:type zen/vector,
    :every
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:focal
      ...
      :_focal {:confirms #{hl7-fhir-r4-core.Element/schema}},
      :coverage
      {:confirms
       #{hl7-fhir-r4-core.Reference/schema zen.fhir/Reference},
       :fhir/flags #{:SU},
       :zen.fhir/reference
       {:refers #{hl7-fhir-r4-core.Coverage/schema}},
    ...
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:number
      ...
      {:confirms #{hl7-fhir-r4-core.code/schema},
       :zen.fhir/value-set
       {:symbol hl7-fhir-r4-core.value-set.note-type/value-set,
        :strength :required},
      ...
      {:confirms #{hl7-fhir-r4-core.CodeableConcept/schema},
       :zen.fhir/value-set
       {:symbol hl7-fhir-r4-core.value-set.languages/value-set,
        :strength :preferred},
       :zen/desc "Language of the text"}},
      ...
      {:fhir/polymorphic true,
       ...
       {:CodeableConcept
        ...
        {:confirms
         #{hl7-fhir-r4-core.Reference/schema zen.fhir/Reference},
         :zen.fhir/reference
         {:refers #{hl7-fhir-r4-core.Condition/schema}}}},
   ...
   :_precedence {:confirms #{hl7-fhir-r4-core.Element/schema}},
   :use
   {:confirms #{hl7-fhir-r4-core.code/schema},
    :fhir/flags #{:SU},
    :zen.fhir/value-set
    {:symbol hl7-fhir-r4-core.value-set.claim-use/value-set,
     :strength :required},
     ...
     {:category
      ...
      {:type zen/vector,
       ...
       {:confirms
        #{hl7-fhir-r4-core.Reference/schema zen.fhir/Reference},
        :zen.fhir/reference
        {:refers #{hl7-fhir-r4-core.Encounter/schema}},
      ...
      {:type zen/vector,
       ...
       {:confirms
        #{hl7-fhir-r4-core.Reference/schema zen.fhir/Reference},
        :zen.fhir/reference
        {:refers #{hl7-fhir-r4-core.Device/schema}},
   ...
   {:confirms #{hl7-fhir-r4-core.CodeableConcept/schema},
    :fhir/flags #{:SU},
    :zen/desc "Category or discipline"},
   :created
   ...
   {:confirms #{hl7-fhir-r4-core.code/schema},
    :fhir/flags #{:SU},
    :zen.fhir/value-set
    {:symbol hl7-fhir-r4-core.value-set.remittance-outcome/value-set,
     :strength :required},
   ...
   {:type zen/vector,
    ...
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:claim
      {:confirms
       #{hl7-fhir-r4-core.Reference/schema zen.fhir/Reference},
       :zen.fhir/reference {:refers #{hl7-fhir-r4-core.Claim/schema}},
      ...
      :reference
      {:confirms #{hl7-fhir-r4-core.Identifier/schema},
       :zen/desc "File or case reference"}},
   ...
   :fundsReserve
   {:confirms #{hl7-fhir-r4-core.CodeableConcept/schema},
    :zen/desc "Funds reserved status"},
   :priority
   {:confirms #{hl7-fhir-r4-core.CodeableConcept/schema},
   ...
   {:confirms #{hl7-fhir-r4-core.code/schema},
    ...
    :zen.fhir/value-set
    {:symbol
     hl7-fhir-r4-core.value-set.explanationofbenefit-status/value-set,
     :strength :required},
   ...
   {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
    ...
    {:type
     {:confirms #{hl7-fhir-r4-core.CodeableConcept/schema},
      :zen/desc "Category of recipient"},
     :party
     {:confirms
      #{hl7-fhir-r4-core.Reference/schema zen.fhir/Reference},
      :zen.fhir/reference
   ...
   {:type zen/vector,
    ...
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:sequence
      ...
      :_responsible {:confirms #{hl7-fhir-r4-core.Element/schema}},
      :role
      {:confirms #{hl7-fhir-r4-core.CodeableConcept/schema},
