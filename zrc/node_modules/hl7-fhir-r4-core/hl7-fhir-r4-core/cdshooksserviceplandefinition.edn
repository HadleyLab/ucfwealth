{ns hl7-fhir-r4-core.cdshooksserviceplandefinition,
 import
    ...
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:description
      {:confirms #{hl7-fhir-r4-core.string/schema},
       :fhir/flags #{:MS}},
      :definition {:fhir/polymorphic true, :fhir/flags #{:MS}},
      ...
      {:type zen/vector,
       ...
       {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
        :fhir/flags #{:MS}}},
      :timing {:fhir/polymorphic true, :fhir/flags #{:MS}},
      :_selectionBehavior
