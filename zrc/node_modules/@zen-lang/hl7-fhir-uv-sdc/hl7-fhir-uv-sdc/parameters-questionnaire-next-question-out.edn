{ns hl7-fhir-uv-sdc.parameters-questionnaire-next-question-out,
 ...
 {:zen/tags #{zen.fhir/profile-schema zen/schema},
  ...
  :zen.fhir/profileUri
  "http://hl7.org/fhir/uv/sdc/StructureDefinition/parameters-questionnaire-next-question-out",
  :zen.fhir/version "0.5.18",
  :confirms #{zen.fhir/Resource hl7-fhir-r4-core.Parameters/schema},
  :type zen/map,
  :keys
  {:parameter
   {:slicing
       ...
       {:type zen/vector,
        ...
        {:type zen/map,
         ...
         {:name {:confirms #{hl7-fhir-r4-core.string/schema}},
          ...
          :resource
          {:confirms
           #{hl7-fhir-r4-core.Resource/schema
             hl7-fhir-uv-sdc.sdc-questionnaire-adapt/schema},
           :zen.fhir/nested {}},
          :part {:type zen/vector, :every {}, :maxItems 0}}}},
       :filter {:engine :match, :match {:name "out"}}}}},
    :type zen/vector,
