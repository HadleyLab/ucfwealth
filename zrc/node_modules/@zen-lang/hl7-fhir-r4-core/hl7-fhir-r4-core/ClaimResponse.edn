{ns hl7-fhir-r4-core.ClaimResponse,
 import
 ...
 {:zen.fhir/version "0.5.18",
  ...
  {:_created {:confirms #{hl7-fhir-r4-core.Element/schema}},
   ...
   {:type zen/vector,
    ...
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:itemSequence
      ...
      :_itemSequence {:confirms #{hl7-fhir-r4-core.Element/schema}},
      :noteNumber
      {:type zen/vector,
       :every
       {:confirms #{hl7-fhir-r4-core.positiveInt/schema},
   ...
   {:type zen/vector,
    ...
    {:confirms #{hl7-fhir-r4-core.Reference/schema zen.fhir/Reference},
     :zen.fhir/reference
     {:refers #{hl7-fhir-r4-core.CommunicationRequest/schema}},
   ...
   {:confirms #{hl7-fhir-r4-core.code/schema},
    :fhir/flags #{:SU :?!},
    :zen.fhir/value-set
    {:symbol hl7-fhir-r4-core.value-set.fm-status/value-set,
     :strength :required},
   ...
   {:type zen/vector,
    ...
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:itemSequence
      ...
      :_detailSequence {:confirms #{hl7-fhir-r4-core.Element/schema}},
      :subDetailSequence
      {:confirms #{hl7-fhir-r4-core.positiveInt/schema},
