{ns hl7-fhir-r4-core.Patient,
 ...
 #{hl7-fhir-r4-core.integer
   ...
   hl7-fhir-r4-core.value-set.link-type
 ...
 {:zen/tags #{zen/schema zen.fhir/base-schema},
  ...
  {:_active {:confirms #{hl7-fhir-r4-core.Element/schema}},
    ...
    {:confirms #{hl7-fhir-r4-core.BackboneElement/schema},
     ...
     {:other
      ...
      {:confirms #{hl7-fhir-r4-core.code/schema},
       :fhir/flags #{:SU},
       :zen.fhir/value-set
       {:symbol hl7-fhir-r4-core.value-set.link-type/value-set,
        :strength :required},
   ...
   {:confirms #{hl7-fhir-r4-core.code/schema},
    ...
    :zen.fhir/value-set
    {:symbol
     hl7-fhir-r4-core.value-set.administrative-gender/value-set,
     :strength :required},
